<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsultaPacientesUserControl.ascx.cs" Inherits="AnalisisAplicada2.UI.UserControls.ConsultaPacientesUserControl" %>
